...
const CONTRACT_ADDRESS = "0xd36D9825DF57bAD1a070E23558b701cDAf97a2b4";
const OPENSEA_URL = "https://testnets.opensea.io/collection/squarenft-uvbyhsip7a";
...
const App = () => {
  ...
  const renderMintButton = () => {
    ...
    return (
      <button disabled className="cta-button connect-wallet-button">Processing...</button>
    )
  }
  ...
  const renderViewCollectionButton = () => {
    return (
      ...
      }} className="cta-button view-collection-button">🌊 View Collection on OpenSea</button>
    )
  }
